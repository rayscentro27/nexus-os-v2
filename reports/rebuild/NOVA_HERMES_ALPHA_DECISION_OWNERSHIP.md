# Alpha decision ownership

Alpha remains a governed research capability with its request/result/artifact correlation and evidence receipt intact. The final presentation prompt requires Nova to state whether it still agrees with the prior recommendation, summarize only decision-relevant findings, and explain what changed.
