...
bounded specialist, sequential, and multi-step probes in 27.21s, 37.19s, and
38.16s respectively. A first current-state probe returned malformed output,
so reliability is improved but not perfect.
