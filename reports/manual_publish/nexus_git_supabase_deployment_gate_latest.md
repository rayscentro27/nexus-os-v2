...
- two_commits_ahead_found: true
- secret_safety_clean: true
- pre_push_build_passed: true
- git_pushed: true
- netlify_deployed: true
- admin_routes_live: true
- client_routes_live: true
- migration_reviewed: true
- migration_timestamped: true
- local_supabase_test_attempted: true
- local_test_passed: false
- production_db_push_attempted: false
- production_db_push_passed: false
- target_project_ref: iqjwgpnujbeoyaeuwehj
- insert_dry_run_passed: true
