...
Result after adding the inbox policy test: **7 files passed, 40 tests passed**.
...
Result: **40 files passed, 841 tests passed** in 18.65 seconds. No known unrelated failure remains.
