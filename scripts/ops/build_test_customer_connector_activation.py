...
def build():
 ...
 hermes={"ok":True,"generated_at":now(),"status":"admin_brief_ready","recommendations":recommendations,"next_money_action":"Approve one Stripe CLI test-mode $97 Checkout, then prove webhook-to-test-client idempotency before persistent insertion.","what_must_stay_gated":["Stripe API writes","persistent fake-client insertion","NotebookLM CLI auth","Oanda demo connectivity/orders","public publishing","live Supabase inserts"],"external_action_performed":False}
