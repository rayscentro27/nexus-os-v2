...
SAFE_LOOP={"youtube_api_metadata_refresh","youtube_transcript_import","youtube_research_scoring","youtube_research_outputs","notebooklm_source_import"}
