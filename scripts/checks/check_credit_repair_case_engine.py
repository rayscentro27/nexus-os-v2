...
add("profile review route content exists in WorldClassClientPortal", "CreditRepairCaseEnginePanel" in texts["world"] and "Profile Review Cases" in texts["world"])
add("documentation reason selector exists", "Documentation Reason Selector" in texts["world"] and "not_mine" in texts["knowledge"] and "incorrect_balance" in texts["knowledge"])
...
add("Clyde funding-readiness guide language exists", "funding readiness" in texts["world"] and "documentation options" in texts["world"])
...
add("/admin/credit-specialist references profile review cases", "Profile Review Cases" in texts["admin"] and "OUTCOME_CATEGORIES" in texts["admin"])
