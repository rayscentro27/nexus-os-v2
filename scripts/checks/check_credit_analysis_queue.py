...
terms=['queued','processing','complete','failed','needs_manual_review','--max-jobs','min(args.max_jobs, 10)','status=eq.queued','credit_analysis_jobs_one_active_per_document','queueCreditReportAnalysis']
