...
def envs():
 ...
 names=["OANDA_API_TOKEN","OANDA_API_KEY","OANDA_ACCESS_TOKEN","OANDA_ACCOUNT_ID","OANDA_ENVIRONMENT","OANDA_API_URL","OANDA_LIVE_ACCOUNT_ID","LIVE_TRADING","TRADING_LIVE"]
 ...
 return present, ("practice" if any(x in mode for x in ("practice","demo")) else "live_detected_blocked" if "fxtrade" in mode or mode == "live" else "practice_candidate" if (present["OANDA_API_TOKEN"] or present["OANDA_API_KEY"] or present["OANDA_ACCESS_TOKEN"]) and present["OANDA_ACCOUNT_ID"] else "unverified")
...
def build():
 ...
 demo_ready=mode in {"practice","practice_candidate"} and (present["OANDA_API_TOKEN"] or present["OANDA_API_KEY"] or present["OANDA_ACCESS_TOKEN"]) and present["OANDA_ACCOUNT_ID"]
