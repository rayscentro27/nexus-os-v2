...
IMPLEMENTED_FEEDERS = {
    ...
    goclear_revenue_hub_feeder.FEEDER_ID: goclear_revenue_hub_feeder,
...
FEEDERS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "next_action": "Run manual watch dry-run; scheduler activation requires Ray approval.",
    },
    {
        ...
        "next_action": "Use dry-run scouts and convert strong findings into experiments.",
    },
    {
    ...
    },
    {
        ...
        "next_action": "Dry-run GoClear revenue metric candidates; live writes create internal cards only.",
    },
    {
