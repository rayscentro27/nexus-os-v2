...
def build():
 ...
 report={"ok":True,"generated_at":now(),"status":"plan_ready_requires_Ray_approval","stripe_cli_installed":cli["installed"],"stripe_cli_test_mode_verified":cli["test_mode_verified"],"webhook_secret_present":env["presence"]["STRIPE_WEBHOOK_SECRET"],"listener_started":False,"test_event_sent":False,"real_charge_created":False,"external_action_performed":False,"plan":plan}
