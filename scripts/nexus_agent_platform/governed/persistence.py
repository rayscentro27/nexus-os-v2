...
COLLECTIONS = ("approvals", "work_orders", "recommendations", "audit", "queue", "research_requests", "result_feedback", "opportunities", "revenue_observations", "revenue_snapshots", "growth_experiments", "creative_briefs", "creative_assets", "creative_receipts", "creative_concepts", "creative_feedback", "creative_preference_profiles", "creative_campaigns", "creative_territories", "creative_jobs", "creative_ai", "creative_media", "creative_reviews", "creative_learning", "finance_resource_ledger", "finance_cost_receipts", "finance_revenue", "finance_learning", "specialists", "specialist_permissions", "skill_assignments", "goals", "loop_state", "metrics", "improvement_candidates", "trading_strategies", "business_ideas", "business_research", "business_receipts", "launch_candidates", "outcomes", "trading_experiments", "trading_journal", "trading_learning", "trading_paper_observations", "trading_replays", "trading_portfolios", "trading_mcp_audits", "knowledge_refreshes", "alpha_source_registry", "alpha_theme_registry", "alpha_content", "alpha_claims", "alpha_research", "alpha_discovery_queue", "alpha_outcomes", "alpha_evaluations", "adaptive_diagnoses", "adaptive_variants", "adaptive_learning", "adaptive_runs")
