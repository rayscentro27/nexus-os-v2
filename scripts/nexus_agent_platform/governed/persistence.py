...
COLLECTIONS = ("approvals", "work_orders", "recommendations", "audit", "queue", "opportunities", "revenue_observations", "revenue_snapshots", "growth_experiments", "creative_briefs", "creative_assets", "creative_receipts")
