...
export const nexusEngineStatusData = {
  ...
  sameDayOperations: {
    ...
    youtubeIntake: 'real_metadata_review_active_ytdlp_local',
    youtubeExactBlocker: 'API intake needs a YouTube API key; transcript review needs approved source text',
  ...
  youtubeResearch: {
    ...
    currentMode: 'real_metadata_review_active_ytdlp_local',
    approvedTargets: 4,
    reviewedItems: 4,
    opportunities: 4,
    rayReviewCards: 5,
  ...
  automationSchedules: {
    ...
    approvalGated: 3,
    blockedExternal: 3,
    nextRecommendedRun: 'YouTube API refresh when a key is configured; transcript chain when approved TXT arrives',
