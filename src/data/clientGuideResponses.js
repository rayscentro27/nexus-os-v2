export const clientGuideResponses = {
  what_do_i_do_next: 'Upload current address proof and your revenue summary. Those two items unblock the next GoClear readiness review.',
  why_not_funding_ready: 'Your demo profile is Almost Ready. Utilization, business-profile gaps, banking history, and two missing documents still need review.',
  how_to_improve_credit: 'Focus on on-time payments, manageable utilization, avoiding unnecessary applications, and completing GoClear-requested documentation. Results are not guaranteed.',
  business_profile_next_step: 'Complete your professional email/domain and review the DUNS or business-bureau path with GoClear before paying for any service.',
...
export const clientGuideQuestionLabels = {
  what_do_i_do_next: 'What do I do next?',
  why_not_funding_ready: 'Why am I not funding-ready?',
