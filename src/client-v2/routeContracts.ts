...
export const V2_ROUTE_CONTRACTS: Record<string, V2RouteContract> = {
  ...
  '/client-v2/goals': { purpose: 'Customer goals and milestones', realData: ['goal summary', 'milestones', 'use-of-funds evidence state', 'next action'], actions: ['view', 'acknowledge next action'], backend: ['Supabase client readiness context', 'customer-goals domain contract'], access: 'authenticated client or FREE_GUEST', mobile: 'single-column milestones; no dense tables', visualDesignPending: true },
