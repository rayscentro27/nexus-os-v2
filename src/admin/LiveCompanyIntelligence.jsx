...
export default function LiveCompanyIntelligence({ surface = null }) {
  const fallbackState = { ...snapshot, ray_decisions: { ...(snapshot.ray_decisions || {}), count: reviewQueue.length, items: reviewQueue }, research_v2: { human_review_queue_count: reviewQueue.length, machine_work_remains: true, global_stop_required: false } }
