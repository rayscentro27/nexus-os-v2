  ...
  return <main className="live-command-page">
    ...
    <div className="live-command-main">
      ...
      <div className="live-command-content">
        ...
        <div className="live-command-metrics">{metrics.map(([icon, label, value, note, tone]) => <CommandMetric key={label} icon={icon} label={label} value={value} note={note} tone={tone} />)}</div><GoclearBetaProjectionPanel />
