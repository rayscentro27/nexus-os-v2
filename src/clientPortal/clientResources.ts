...
const resources: ClientResourceRecommendation[] = [
  ...
  {
    title: 'Credit Report Review Tools',
    category: 'Credit Report Review Tools',
    description: 'Learn how report-item review, draft letter tools, and DocuPost approval gates work.',
    ctaLabel: 'View report review tools',
