...
function CreditPanel({ live, refreshLiveData, navigate, existingDocuments, onUploaded, openUploadPanel }) {
...
export default function WorldClassClientPortal({ path, onNavigate }) {
  ...
  const panel = showIcons ? <IconSystemPanel /> : {
    ...
    credit: <CreditPanel live={live} refreshLiveData={refreshLiveData} navigate={routeTo} existingDocuments={existingDocuments} onUploaded={refreshLiveData} openUploadPanel={openUploadPanel} />,
