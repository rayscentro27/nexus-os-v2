...
import { loadClientPortalLiveData, loadClientProfileIntake, saveClientProfileIntake, checkProfileIntakeComplete, saveCreditStrategyDecision, requestCreditStrategyTool, saveVersionedStrategySelection, linkStrategyEvidence } from '../../lib/clientPortalDataAdapter'
...
function CreditStrategyCards({ live, refreshLiveData, navigate }) {
  ...
  const choose = async (rec, decision, toolType) => {
