...
const pageMeta = {
  ...
  '/client/credit-profile': { key: 'credit', title: 'Credit Journey' },
  ...
  '/client/business-journey': { key: 'business', title: 'Business Journey' },
...
const navItems = [
  ...
  ['/client/business-journey', 'Business', '♟'],
...
function HomePanel({ scores, live, profileComplete, navigate, openUploadPanel, readiness, journey, existingDocuments, onUploaded }) {
  ...
  return <section className="wc-panel wc-panel-home">
    <Hero eyebrow="Nexus 3.0" title="Funding Readiness Command Center" text="Track credit, business, documents, review status, and the next three actions that move you toward funding readiness." />
